    ...
    <div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <fieldset className="fieldset">
            ...
            <fieldset className="fieldset">
              ...
              >
                <option disabled={true}>Pick a region</option>
                {districtByRigion(senderRegion).map((r, i) => (
                  <option key={i} value={r}>
                    {r}
                  </option>
                ))}
          ...
          <fieldset className="fieldset">
            ...
            <fieldset className="fieldset">
              ...
              >
                ...
                {districtByRigion(receiverRegion).map((d, i) => (
        ...
        <input
          type="submit"
          value="Send Parcel"
          className="btn btn-primary text-black mt-12 w-50"
        />
      </form>
    </div>
  );
